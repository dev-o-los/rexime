...
const AnimatedLogoCloud = () => {
  return (
    <div className="w-full pt-40 pb-60">
      <p className="text-center text-xl font-medium pb-12">
        Get hired in more than 2.2 million companies worldwide
      </p>
      <div className="mx-auto w-full px-4 md:px-32">
        <div
