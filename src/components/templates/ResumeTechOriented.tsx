  ...
  <div className="mt-3">
    {section.items.map((item, index) => (
      <div key={index} className="mb-4">
        {item.title && (
          <h4 className={`text-sm font-bold uppercase mb-2 ${colorClass} border-opacity-50`}>
            {item.title}
          </h4>
        )}
...
export const ResumeTechOriented = ({
  ...
  const sidebarClasses = 'w-[30%] pl-4 border-l border-gray-200 print:w-full print:order-2 print:border-none print:pt-4'; 
